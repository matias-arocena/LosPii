...
<div id="pagina">
<div id="cabecera">
<div align="center"><a href="../index.php"><img src="/imagen/empresa.png" width="75em" height="60em" /></a></div>
	...
	if(verificarmail($_REQUEST['mail'])){
		$conexion=mysql_connect($host,$usuario,$contra) or 
			...
			mysql_select_db($db,$conexion) or
				die ("Problemas de Conexion");
			mysql_query("INSERT INTO administracion(mail,nombre) VALUES ('$_REQUEST[mail]','$_REQUEST[nombre]')",$conexion) or
